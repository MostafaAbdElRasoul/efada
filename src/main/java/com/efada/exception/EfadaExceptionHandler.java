...
public class EfadaExceptionHandler {
	...
	public ResponseEntity<BaseResponse> handleNoSuchElementException(NoSuchElementException ex, Locale locale){
	...
	public ResponseEntity<BaseResponse> handleEfadaCustomException(EfadaCustomException ex, Locale locale){
